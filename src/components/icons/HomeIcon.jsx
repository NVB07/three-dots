const HomeIcon = ({ width = 24, height = 24, color = "currentColor", solid = false }) => {
    ...
    return (
        <>
            <svg width={width} height={height} opacity={0.6} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                    <path
                        ...
                        strokeWidth="1.5"
                    ></path>
                    <path d="M15 18H9" stroke={color} strokeWidth="1.5" strokeLinecap="round"></path>
                </g>
            </svg>
        </>
    );
